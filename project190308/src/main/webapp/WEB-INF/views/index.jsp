...
<title>Insert title here</title>
  ...
  <link href="resources/css/now-ui-kit.css?v=1.2.0" rel="stylesheet" />
...
<body class="index-page sidebar-collapse">
  ...
  <div class="wrapper">
    <div class="page-header clear-filter" filter-color="orange">
      <div class="page-header-image" data-parallax="true" style="background-image:url('resources/img/header.jpg');">
      </div>
      <div class="container">
	              ...
	              <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	                ...
	                <div class="carousel-inner" role="listbox">
	                  <div class="carousel-item active">
	                    <img class="d-block" src="resources/img/bg1.jpg" alt="First slide">
	                    <div class="carousel-caption d-none d-md-block">
	                      <h5>Nature, United States</h5>
	                    </div>
	                  </div>
	                  <div class="carousel-item">
	                    <img class="d-block" src="resources/img/bg3.jpg" alt="Second slide">
	                    <div class="carousel-caption d-none d-md-block">
	                      <h5>Somewhere Beyond, United States</h5>
	                    </div>
	                  </div>
	                  <div class="carousel-item">
	                    <img class="d-block" src="resources/img/bg4.jpg" alt="Third slide">
	                    <div class="carousel-caption d-none d-md-block">
        ...
        <h6 class="category category-absolute">Designed by
          <a href="http://invisionapp.com/" target="_blank">
            <img src="resources/img/invision-white-slim.png" class="invision-logo" />
          </a>. Coded by
          <a href="https://www.creative-tim.com" target="_blank">
            <img src="resources/img/creative-tim-white-slim2.png" class="creative-tim-logo" />
          </a>.</h6>
      </div>
    </div>
    <div class="main">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="hero-images-container">
                <img src="resources/img/hero-image-1.png" alt="">
              </div>
              <div class="hero-images-container-1">
                <img src="resources/img/hero-image-2.png" alt="">
              </div>
              <div class="hero-images-container-2">
                <img src="resources/img/hero-image-3.png" alt="">
              </div>
            </div>
          </div>
        </div>
          ...
          <div id="images">
            ...
            <div class="row">
              <div class="col-sm-2">
                ...
                <img src="resources/img/julie.jpg" alt="Rounded Image" class="rounded">
              </div>
              <div class="col-sm-2">
                <p class="category">Circle Image</p>
                <img src="resources/img/julie.jpg" alt="Circle Image" class="rounded-circle">
              </div>
              <div class="col-sm-2">
                <p class="category">Raised</p>
                <img src="resources/img/julie.jpg" alt="Raised Image" class="rounded img-raised">
              </div>
              <div class="col-sm-2">
                <p class="category">Circle Raised</p>
                <img src="resources/img/julie.jpg" alt="Thumbnail Image" class="rounded-circle img-raised">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="section section-signup" style="background-image: url('resources/img/bg11.jpg'); background-size: cover; background-position: top center; min-height: 700px;">
        <div class="container">
          <div class="row">
          ...
          <div class="row">
            <div class="col">
              <a href="examples/landing-page.html" target="_blank">
                <img src="resources/img/landing.jpg" alt="Image" class="img-raised">
              </a>
              <a href="examples/landing-page.html" class="btn btn-simple btn-primary btn-round">View Landing Page</a>
            </div>
            <div class="col">
              <a href="examples/profile-page.html" target="_blank">
                <img src="resources/img/profile.jpg" alt="Image" class="img-raised">
              </a>
  ...
  <script src="resources/js/now-ui-kit.js?v=1.2.0" type="text/javascript"></script>
  <script>
    $(document).ready(function() {
      // the body of this function is in resources/js/now-ui-kit.js
